            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="card-title mb-5">Add New Portfolio</h3>
                        <form action="{{ route('portfolio.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="portfolio_string"
                                        id="example-text-input">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Insert Portfolio
                                    Image</label>
                                <div class="col-sm-10">
                            ...
                            <center>
                                <input type="submit" class="btn btn-lg btn-info" value="Add New Portfolio">
                            </center>
