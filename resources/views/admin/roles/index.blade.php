                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Add/Edit Role Permission</th>
                                    <th>Action</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-bold"><a href="{{ route('give-permission',$roles['id']) }}"
                                            class="btn btn-primary sm">Add/Edit Role Permission</a>
                                    </td>
                                    <td>

                                        <a href="{{ route('role.edit',$roles['id']) }}" class="btn btn-info sm"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="{{ route('role.delete',$roles['id']) }}" class="btn btn-danger sm"
